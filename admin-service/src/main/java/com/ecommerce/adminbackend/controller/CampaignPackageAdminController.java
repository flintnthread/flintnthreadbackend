...
@RestController
@RequestMapping("/api/admin/ads/campaigns")
@RequiredArgsConstructor
public class CampaignPackageAdminController {

    private final CampaignPackageAdminService service;
    ...
    public Map<String, Object> delete(@PathVariable Integer id) {
        service.delete(id);
        return Map.of("message", "Campaign package deleted.");
    }
}
