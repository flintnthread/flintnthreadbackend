...
@RestController
@RequestMapping("/api/admin/ads/performance")
@RequiredArgsConstructor
public class PerformanceAdAdminController {

    private final PerformanceAdAdminService service;
    ...
    public Map<String, Object> delete(@PathVariable Integer id) {
        service.delete(id);
        return Map.of("message", "Performance ad deleted.");
    }
}
