...
@RestController
@RequestMapping("/api/admin/ads/admin-users")
@RequiredArgsConstructor
public class AdsAdminUserAdminController {

    private final AdsAdminUserAdminService service;
    ...
    public Map<String, Object> delete(@PathVariable Integer id) {
        service.delete(id);
        return Map.of("message", "Ads admin user deleted.");
    }
}
