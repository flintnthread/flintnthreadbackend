...
/**
 * Stores temporary deactivation / activation request metadata in existing {@code sellers.admin_remarks}
 * (JSON under key {@code accountLifecycle}). No new DB columns.
 */
public final class SellerAccountLifecycleSupport {
    ...
    public static String writeLifecycle(String existingRemarks, Map<String, Object> lifecycle) {
        ...
        // Preserve plain-text legacy note when previous value was not JSON.
